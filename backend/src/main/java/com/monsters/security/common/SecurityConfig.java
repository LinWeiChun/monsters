    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/auth/email-changes").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/auth/member-restorations")
                                .hasAuthority("CONTINUATION_REACTIVATE_ACCOUNT")
